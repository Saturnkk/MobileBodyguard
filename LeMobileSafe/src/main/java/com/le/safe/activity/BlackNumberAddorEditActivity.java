...
public class BlackNumberAddorEditActivity extends BaseActivity implements OnClickListener {
    ...
    protected View createXMLView() {
        View view = View.inflate(this, R.layout.activity_blacknumberaddoredit, null);
        return view;
    }
